...
> Live page — update whenever positions change. **2026-09-22 23:40 CEST review (2nd run today):** UK and most EU positions now carry genuine same-day 2026-09-22 closes (ACN is an isolated one-day-stale exception, still on 09-21); all US-listed positions remain on 09-21 closes — today's US close hadn't yet landed in Turso at review time. **Found and fixed a real bug**: the Options Positions table's "Mkt Value (€)" column was copying Turso's `option_marks.mkt_value` (native USD) directly as if it were EUR, overstating the combined options mark-to-market by ~€172 — corrected below. **No trades executed today.** FLUT and SFM still carry mechanical Exit (FLUT: 1 share, non-viable to execute; SFM: patience window to ~2026-10-05). Cash unchanged at **€1,222.86**. Total net value ≈**€18,512** (corrected; the options bug had been inflating this figure — see Portfolio Net Value below). 22 open positions (18 long equity, 1 short, 3 options). See [[#Portfolio Risks (Burry Lens)|risks]] below and the fred-dashboard Morning Briefing for full detail. Three new 5/5-scored candidates screened (MO — repeat idea, IAG, MONY) and recorded to the Pending Trade Ideas queue; none executed — available cash of ~€1,223 doesn't cover any at the €1,500 target size.

---

## Portfolio Net Value

**Total Net Value: ≈ €18,512** (as of 2026-09-22 23:40 CEST; UK/most-EU positions on genuine same-day 09-22 closes, ACN and all US-listed positions still on 09-21 closes)

| Component | Value (€) | Basis |
| --- | --- | --- |
| Long equity (market price) | €16,103 | Sum of Mkt Value across all 18 open long positions, converted to EUR |
| Options (market price) | €1,183 | ORCL put ≈€458 + PLTR put ≈€627 + META Oct-09 $885 call ≈€98 — Turso Black-Scholes estimates (native USD, converted to EUR), mark_date 2026-09-22 |
...
| **Total Net Value** | **€18,512** | |

> **Methodology note:** Shorts are traded on margin and don't hold cash value themselves while open — only their unrealized P&L (market price vs. entry price) contributes to net worth, per [[#Short Positions\|Short Positions]]. FX used: EUR/USD 1.14548 (Turso, 2026-09-22 pull). **Correction (2026-09-22 23:40 CEST):** the Options row here, and the Options Positions table below, were previously overstated by ~€172 — `option_marks.mkt_value` from Turso is in the option's native USD, not EUR, and prior updates to this page copied it into the "€" columns unconverted. The ≈€93 drop from the last-reported €18,605 is this fix plus small genuine price movement, not a real portfolio loss. Recompute this section whenever prices in Open Positions / Short Positions / Options Positions are refreshed — it is not automatically kept in sync.
...
| Accenture | ACN | Xetra | EUR | 6 | €141.10 | €846.60 | €162.10 | €972.60 | +14.88% | 👀 Watch | Global IT services & consulting. Correct listing is Xetra/Frankfurt ticker **CSA** (ISIN IE00B4BNMY34, WKN A0YAQA), confirmed 2026-08-04. RSI 54.7, above 50d SMA (€149.32), MACD bearish. **Price one day stale (2026-09-21)** as of the 2026-09-22 23:40 CEST review — sits in the same EU/Xetra batch as SAP/EDEN/PRX/WKL/ZOE/QXO-PB, all of which refreshed to 09-22; isolated single-ticker gap, not a batch issue |
| Adobe | ADBE | NASDAQ | USD | 5 | $249.85 | $1,249.25 | $249.52 | $1,247.60 | -0.13% | 👀 Watch | Creative & document software; AI integration (Firefly). RSI 42.8, below SMA50 ($256.58), MACD bearish — earnings reported 2026-09-10, reaction muted. Fresh 2026-09-21 US close (today's 09-22 US close not yet in Turso as of this 23:40 CEST review) |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Oracle | ORCL | NYSE | USD | 3 | $149.89 | $449.67 | ✅ Hold | Equity short complementing the existing ORCL long put below; bearish on Oracle AI/OCI narrative (OCI +93% YoY — short profitable only if AI infrastructure thesis unwinds); initiated 2026-08-14. Still on 2026-09-21 US close ($148.56, today's 09-22 close not yet in Turso as of this 23:40 CEST review) — unrealized +0.89% (+$3.99, ~+€3), small gain vs. entry |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Oracle | ORCL | Long Put | $120 | 2026-12-18 | 1 | 100 | $11.38/sh | €993 | ~$5.24/sh (est.) | ~€458 (est.) | ✅ Hold | Right to sell ORCL at $120 by Dec 2026; bearish on Oracle AI/OCI narrative (OCI +93% YoY — put profitable only if AI infrastructure thesis accelerates); break-even $108.62; initiated 2026-08-06. ORCL $148.56 (2026-09-21 close), down from $150.15 entry — ~37% above breakeven, deep OTM. **Turso Black-Scholes estimate, mark_date 2026-09-22** — no live options chain available to cross-check. Unrealized loss ≈−€536 |
| Palantir | PLTR | Long Put | $125 | 2027-03-19 | 1 | 100 | $8.24/sh | €719 | ~$7.18/sh (est.) | ~€627 (est.) | ✅ Hold | Right to sell PLTR at $125 by Mar 2027; break-even $116.76; initiated 2026-08-11. PLTR $183.09 (2026-09-21 close), 57% above breakeven, deep OTM, long-dated — monitor only. **Turso Black-Scholes estimate, mark_date 2026-09-22** — model estimate, not a live option-chain quote. Unrealized loss ≈−€92 |
| Meta Platforms | META | Long Call | $885 | 2026-10-09 | 1 | 100 | $3.08/sh | €269 | ~$1.12/sh (est.) | ~€98 (est.) | ✅ Hold | **New position, opened 2026-09-21** (entered directly, not via a prior briefing recommendation). Right to buy META at $885 by Oct 2026; bullish overlay on top of the existing META common-stock position above; break-even $888.08; META $741.25 (2026-09-21 close) — ~16% below breakeven, deep OTM, short-dated (expires in <3 weeks). **Turso Black-Scholes estimate, mark_date 2026-09-22** — no live options chain available to cross-check; unrealized loss ≈−€171 on premium paid, reflects both OTM-ness and rapid theta decay this close to expiry |

> Long puts: profitable if the underlying closes below break-even at expiry (the META call is the inverse — profitable above breakeven). Maximum loss = premium paid (ORCL €993, PLTR €719, META €269). Current combined mark-to-market value: ≈€1,183 (Turso Black-Scholes estimate) across all three, re-derived from 2026-09-21 underlying closes, not directly quoted from a live options chain. **Corrected 2026-09-22 (23:40 CEST review):** `option_marks.mkt_value` from Turso is in the option's native currency (USD for all three) — prior versions of this table copied that USD figure directly into the "€" Mkt Value column without converting, overstating the combined mark-to-market by ~€172 (was shown as ≈€1,355). Total Cost (€) was already correctly converted; only Mkt Value (€) and the per-position unrealized-loss figures were wrong.
